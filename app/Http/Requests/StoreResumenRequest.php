...
class StoreResumenRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Unicidad compuesta
            Rule::unique('resumen')->where(function ($q) {
    ...
    {
        return [
            'resumen_unique' => 'Ya existe un registro para esa combinación (fecha/día/usuario/geo).',
        ];
    }
}
